...
export default function Landing() {
    ...
    return (
      <div className="bg-no-repeat min-h-screen min-w-screen bg-center bg-cover bg-[#C5C8B5]">
        ...
        <div className='absolute top-[124vw] rounded-[2vw] md:top-[50vw] h-[10vw] w-[45vw] left-[50vw] transform -translate-x-1/2 md:bg-transparent bg-[black] opacity-[10%] md:h-[5vw] md:w-[50vw]'></div>
