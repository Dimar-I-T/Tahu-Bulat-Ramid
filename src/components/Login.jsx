...
export default function Login() {
    ...
    return (
      <div className="bg-cover bg-no-repeat bg-center bg-[#C5C8B5] w-screen h-screen">
        ...
        <button
           onClick = {navToReg}
           className = "fixed border-[0.2vw] border-[#F4DF00] opacity-[80%] hover:opacity-[100%] font-inconsolata text-[3.5vw] md:text-[2vw] text-[#F4DF00] bg-transparent top-[1.5vw] md:top-[0.5vw] right-[5vw] w-[15vw] h-[6vw] md:w-[10vw] md:h-[4vw]">
            Sign Up
        </button>
        <div className="flex justify-center left-1/2 transform -translate-x-1/2 top-1/2 -translate-y-1/2 items-center w-[100vw] h-[60vw] md:h-[20vw] relative">
          <div className="relative bg-transparent aspect-[3/2] w-[60vw] max-w-[1100px] max-h-[700px] items-center mt-[5vw] gap-5 rounded-[5vw] opacity-80">
            ...
            <input onChange = {changeUser} placeholder="Masukkan username-mu" value = {valUser} class="absolute border-[0.3vw] md:border-[0.2vw] border-[black] ml-[27vw] md:ml-[25vw] top-[6.5vw] md:top-[12.5vw] w-[33vw] h-[6vw] md:w-[25vw] md:h-[3.5vw] px-[1.5vw] md:px-[0.9vw] rounded-[3vw] md:rounded-[2vw] font-inconsolata text-[3vw] md:text-[2vw] focus:outline-none"/>
              ...
              type="password"/>
              <button type="submit" className="absolute rounded-[3vw] md:rounded-[2vw] border-[0.3vw] border-[black] opacity-[80%] hover:opacity-[100%] font-inconsolata text-[4vw] md:text-[3vw] font-bold text-[black] bg-[#F4DF00] left-1/2 transform -translate-x-1/2 mt-[30vw] md:mt-[27vw] w-[30vw] h-[10vw] md:w-[25vw] md:h-[6vw]"> LOG IN </button>
            </form>
          </div>
        </div>
      </div>
